...
When invoked by `/smelter:research` skill, output these tags to communicate status:
...
### Integration with /smelter:research Skill

The `/smelter:research` skill orchestrates multi-stage research workflows. It reads these promise tags to:
