...
Use /smelter:learner ONLY after:
...
- /smelter:note - Save quick notes that survive compaction (less formal than skills)
- /smelter:feat - Start a development loop with learning capture
